...
if ( !keUser ) {
  ...
  const createDefaultUser = db.prepare('INSERT INTO User (username, password) VALUES (?, ?)');
  createDefaultUser.run("ke", "af9d2c92ddc38ca77b3cd29e944c9b61928032808d3a3cb6c3a3c8965067291e");
}

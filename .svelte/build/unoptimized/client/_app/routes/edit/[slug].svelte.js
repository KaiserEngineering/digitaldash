...
// (157:16) {#each ['banner1.jpg', 'bg.jpg', 'BlackBackground.png', 'CarbonFiber.png'] as background}
function create_each_block_8(ctx) {
	...
	return {
		c() {
			...
			t = text(/*background*/ ctx[50]);
			this.h();
		},
		l(nodes) {
			option = claim_element(nodes, "OPTION", { value: true });
			var option_nodes = children(option);
			t = claim_text(option_nodes, /*background*/ ctx[50]);
			option_nodes.forEach(detach);
			this.h();
		},
		h() {
			option.__value = option_value_value = /*background*/ ctx[50];
...
function create_each_block_7(ctx) {
	...
	return {
		...
		l(nodes) {
			option = claim_element(nodes, "OPTION", { value: true });
			var option_nodes = children(option);
			t = claim_text(option_nodes, /*theme*/ ctx[47]);
			option_nodes.forEach(detach);
			this.h();
		},
		h() {
			option.__value = option_value_value = /*theme*/ ctx[47];
			option.value = option.__value;
		},
		m(target, anchor) {
			insert(target, option, anchor);
...
// (181:24) {#each pids as pid}
function create_each_block_6(ctx) {
	let option;

	let t0_value = (/*KE_PID*/ ctx[2][/*pid*/ ctx[33]].shortName
	? /*KE_PID*/ ctx[2][/*pid*/ ctx[33]].shortName
	: /*KE_PID*/ ctx[2][/*pid*/ ctx[33]].name) + "";
...
function create_each_block_5(ctx) {
	...
	function select0_change_handler_1() {
		/*select0_change_handler_1*/ ctx[12].call(select0, /*i*/ ctx[38]);
	}

	function blur_handler(...args) {
		return /*blur_handler*/ ctx[13](/*i*/ ctx[38], ...args);
	}
	...
	return {
		...
		h() {
			...
			if (/*view*/ ctx[1].gauges[/*i*/ ctx[38]].pid === void 0) add_render_callback(select0_change_handler_1);
			attr(div0, "class", "col-12");
		...
		m(target, anchor) {
			...
			select_option(select0, /*view*/ ctx[1].gauges[/*i*/ ctx[38]].pid);
			append(div2, t1);
			append(div2, div1);
			append(div1, select1);
			select_option(select1, /*view*/ ctx[1].gauges[/*i*/ ctx[38]].unit);
			append(div2, t2);
		...
		p(new_ctx, dirty) {
			...
			if (dirty[0] & /*view*/ 2 && select1_value_value !== (select1_value_value = /*view*/ ctx[1].gauges[/*i*/ ctx[38]].unit)) {
				select_option(select1, /*view*/ ctx[1].gauges[/*i*/ ctx[38]].unit);
			}
		},
		d(detaching) {
...
function create_each_block_4(ctx) {
	...
	return {
		...
		l(nodes) {
			option = claim_element(nodes, "OPTION", { value: true });
			var option_nodes = children(option);
			t0 = claim_text(option_nodes, /*op*/ ctx[30]);
			t1 = claim_space(option_nodes);
			option_nodes.forEach(detach);
			this.h();
		},
...
// (237:20) {#each pids as pid}
function create_each_block_3(ctx) {
	let option;

	let t0_value = (/*pid*/ ctx[33]
	? /*KE_PID*/ ctx[2][/*pid*/ ctx[33]].shortName
		? /*KE_PID*/ ctx[2][/*pid*/ ctx[33]].shortName
		: /*KE_PID*/ ctx[2][/*pid*/ ctx[33]].name
	: "") + "";
...
// (206:10) {#each view.alerts as alert, i}
function create_each_block_2(ctx) {
	...
	function input0_input_handler() {
		/*input0_input_handler*/ ctx[14].call(input0, /*each_value_2*/ ctx[37], /*i*/ ctx[38]);
	}

	function input1_input_handler_1() {
		/*input1_input_handler_1*/ ctx[15].call(input1, /*each_value_2*/ ctx[37], /*i*/ ctx[38]);
	}
	...
	function select0_change_handler_2() {
		/*select0_change_handler_2*/ ctx[16].call(select0, /*each_value_2*/ ctx[37], /*i*/ ctx[38]);
	}
	...
	function select1_change_handler_1() {
		/*select1_change_handler_1*/ ctx[17].call(select1, /*each_value_2*/ ctx[37], /*i*/ ctx[38]);
	}

	function blur_handler_1(...args) {
		return /*blur_handler_1*/ ctx[18](/*alert*/ ctx[36], /*each_value_2*/ ctx[37], /*i*/ ctx[38], ...args);
	}

	function input2_input_handler() {
		/*input2_input_handler*/ ctx[19].call(input2, /*each_value_2*/ ctx[37], /*i*/ ctx[38]);
	}

	function click_handler() {
		return /*click_handler*/ ctx[20](/*i*/ ctx[38]);
	}
	...
	return {
		...
		h() {
			...
			if (/*alert*/ ctx[36].op === void 0) add_render_callback(select0_change_handler_2);
			...
			select1.required = true;
			if (/*alert*/ ctx[36].pid === void 0) add_render_callback(select1_change_handler_1);
		...
		m(target, anchor) {
			...
			select_option(select0, /*alert*/ ctx[36].op);
			append(div6, t9);
			append(div6, div3);
			append(div3, label3);
			append(label3, t10);
			...
			select_option(select1, /*alert*/ ctx[36].pid);
			append(div6, t13);
			append(div6, div4);
			append(div4, label4);
			append(label4, t14);
			...
			append(select2, option2);
			append(option2, t16);
			select_option(select2, /*alert*/ ctx[36].unit);
			append(div6, t17);
			append(div6, div5);
			append(div5, label5);
			append(label5, t18);
		...
		p(new_ctx, dirty) {
			...
			if (dirty[0] & /*view*/ 2 && input0.value !== /*alert*/ ctx[36].message) {
				set_input_value(input0, /*alert*/ ctx[36].message);
			}

			if (dirty[0] & /*view*/ 2 && input1.value !== /*alert*/ ctx[36].value) {
				set_input_value(input1, /*alert*/ ctx[36].value);
			}
			...
			if (dirty[0] & /*view*/ 2 && select2_value_value !== (select2_value_value = /*alert*/ ctx[36].unit)) {
				select_option(select2, /*alert*/ ctx[36].unit);
			}

			if (dirty[0] & /*view*/ 2 && to_number(input2.value) !== /*alert*/ ctx[36].priority) {
				set_input_value(input2, /*alert*/ ctx[36].priority);
			}
		},
		d(detaching) {
